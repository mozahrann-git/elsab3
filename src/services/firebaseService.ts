...
export interface StaffAccess {
  email: string;
  role: 'admin' | 'sales' | 'broker' | 'owner' | 'coordinator' | 'company_owner' | 'marketing' | 'disabled' | null;
  name?: string;
...
export type AccountRole = 'admin' | 'sales' | 'broker' | 'owner' | 'coordinator' | 'company_owner' | 'marketing' | 'disabled';
